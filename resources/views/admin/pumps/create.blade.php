...
<div class="page-wrapper">
    <div class="form-card">
        ...
        <form method="POST" action="{{ route('admin.pumps.store') }}">
            ...
            <div class="form-group">
                <label>Region</label>
                <input type="text" name="region" value="{{ old('region') }}" required placeholder="e.g., Lagos, Abuja">
            ...
            <div class="form-group">
                ...
                <input type="text" name="fuel_type" value="{{ old('fuel_type') }}" required>
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" min="0" name="price_per_litre" value="{{ old('price_per_litre') }}" required>
                @error('price_per_litre') <div class="error">{{ $message }}</div> @enderror
            </div>

            <div class="form-group">
                <label>Stock Litres</label>
                <input type="number" step="0.01" min="0" name="stock" value="{{ old('stock') }}" required>
                @error('stock') <div class="error">{{ $message }}</div> @enderror
            </div>

            <div class="form-group">
                <label>Low Stock Threshold</label>
                <input type="number" step="0.01" min="0" name="low_stock_threshold" value="{{ old('low_stock_threshold') }}">
            </div>
